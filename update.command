#!/bin/bash
# Install the reviewed menu-bar fork, never the upstream release overlay.
set -euo pipefail
...
bash "$UPDATE_DIR/source/local-checks/menu-bar.sh"
